...
ActiveRecord::Schema.define(version: 2022_07_03_135633) do
  ...
  create_table "todos", force: :cascade do |t|
    ...
    t.float "time_span", default: 1.0, null: false
    t.datetime "start_date", null: false
    t.datetime "end_date", null: false
    t.boolean "repeat", default: false, null: false
    t.string "repeat_period", default: "week", null: false
    t.integer "repeat_times", default: 1, null: false
    t.integer "instance_time_span", default: 1, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
